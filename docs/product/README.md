...
| 6 | [`tasks-and-specs/`](stage-1-tasks-and-specs/README.md) | The docs → task → spec → code flow and where humans gate it. Stage 1 — true at every stage. |
| 7 | [`pull-requests/`](stage-2-pull-requests/README.md) | What branches, pull requests and CI add — Stage 2. |
| 8 | [`github-issues/`](stage-3-github-issues/README.md) | What the GitHub Issues mirror adds — Stage 3. |
