...
`docs/product/pipeline.md#flows-and-statuses` (a chapter since split —
today the flows are indexed from
`docs/product/tasks-and-specs/README.md`); the README keeps a
