...
it. One chapter of [`README.md`](README.md), the technical router; read
it when recording a finding rather than working one.
...
later, the route triage sent it down ([report schema](schemas.md#report-schema)).
