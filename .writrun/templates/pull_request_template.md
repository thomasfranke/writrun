...
See docs/product/tasks-and-specs/authoring.md#two-ways-a-permanent-doc-changes.
-->
...
<!-- Implementation PRs: the writrun-check-spec-deltas result. Authoring PRs: this
     check does not apply — an authoring change has no spec to check
     against. Either way, name anything a reviewer should re-read by hand. -->
