...
# scripts (.writrun/scripts/stage-3-github-issues/mirror_issues.sh, reflect_progress.sh).
#
...
REFLECT_PROGRESS="$REPO_ROOT/.writrun/scripts/stage-3-github-issues/reflect_progress.sh"
