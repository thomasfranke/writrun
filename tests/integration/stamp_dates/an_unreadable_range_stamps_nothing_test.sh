...
check "an unreadable range is refused, with git's own words" 3 "fatal:" \
  -- bash "$CI_SCRIPTS/pull-requests/stamp_task_dates.sh" nosuchref...HEAD 2026-08-29T12:00:00Z
...
bash "$CI_SCRIPTS/pull-requests/stamp_task_dates.sh" HEAD~1...HEAD 2026-08-29T12:00:00Z >/dev/null
