...
# would leave the projection about to write a `status:` label onto an
# issue the forge calls terminal, which contradicts itself.
setup_forge
...
forge_not_told "and left for the projection to label" \
