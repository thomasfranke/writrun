...
if grep -q '^# spec-001 — Shaped (for task-001)$' work/specs/spec-001.md &&
   grep -q '^Our sections.$' work/specs/spec-001.md &&
   grep -q '^status: draft$' work/specs/spec-001.md; then
