...
skills. Reports are the exception to the pipeline: nothing selects
them, and recording one rides whatever change is already open. Statuses live in front-matter, never in folder position — nothing
