...
|---|---|---|
| `skills/` | WritRun — the four `writrun-*` skills and their scripts | refreshes |
| `scripts/` | WritRun — the workflow step logic, testable bash (`gh` wherever the forge must be asked) | refreshes |
