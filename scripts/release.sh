...
# finds out at the push — after the tag is local and, with
# `--follow-tags`, already public. A main ahead of origin puts commits
# no pull request reviewed inside the tag. Neither is a reconciliation
# this script should pick, so it names the state and stops.
#
